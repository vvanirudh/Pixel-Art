...
# from bspline import BSpline, Closed_BSpline

class SplineSmoother(object): # This class contains the functionality for optimization of the B-splines
	...
	def smooth_point(self, index, start):
		...
		for _ in range(self.POINT_GUESSES): # Around 20 guesses are made and the minimum energy one is chosen
